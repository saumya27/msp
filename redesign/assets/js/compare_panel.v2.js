...
function addCompareCheckbox () {
    ...
    $('.msplistitem').each(function () {
        ...
        add_comp_html = [
            '<div class="add-to-cmpr">',
                '<input type="checkbox" class="compare-entrypoint" id="compare' + this_mspid + '">',
                '<label for="compare' + this_mspid + '">',
                    '<img class="add-to-cmpr__img" src="http://b12984e4d8c82ca48867-a8f8a87b64e178f478099f5d1e26a20d.r85.cf1.rackcdn.com/add_to_compare.png" alt="add to compare">
                '</label>',
            '</div>'
        ].join("");
