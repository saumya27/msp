...
var ListPage = {
    ...
    "view": {
        ...
        "render": function() {
            ...
            if (lp_clipboard.pageType === "nc") {
                window.history.pushState("", "Filters", ListPage.model.URLParams);
            } else {
            ...
            ;(function updateProductListAndOtherWidgets() {
                ...
                if ($(".body-wrpr").length !== 0) {
                    ...
                    if (!lp_clipboard.isOnLoad || lp_clipboard.pageType != "nc") {
    ...
    "services": {
        "filterURL": {
            ...
            "fromParams": function(params) {
                var separator = $(".body-wrpr").data("page-type") == "nc" ? "?" : "#";


                var filterURL, URLParams = [];
                ...
                filterURL = separator + URLParams.join("&");
